...
@EnableTransactionManagement // транзакции будут выполняться спрингом
@EnableJpaRepositories("tronikol.projects.Library.repositories")
...
//-------------------
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("tronikol.projects.Library.models");
